...
def test(args):
    ...
    model = vitModel(image_size=32, patch_size=4, num_classes=10)
    state_dict = torch.load(args.path_to_model, map_location=device)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test YourViT")
